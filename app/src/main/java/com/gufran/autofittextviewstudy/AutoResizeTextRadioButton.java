...
public class AutoResizeTextRadioButton extends AppCompatRadioButton {
    private static final int NO_LINE_LIMIT = -1;
    private final RectF _availableSpaceRect = new RectF();
    private final AutoResizeTextRadioButton.SizeTester _sizeTester;
    ...
    public AutoResizeTextRadioButton(final Context context) {
        this(context, null, android.R.attr.textViewStyle);
    }

    public AutoResizeTextRadioButton(final Context context, final AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public AutoResizeTextRadioButton(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        // prepare size tester:
        _sizeTester = new AutoResizeTextRadioButton.SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (transformationMethod != null)
                    text = transformationMethod.getTransformation(getText(), AutoResizeTextRadioButton.this).toString();
                else
...
//    });
    ...
    private int binarySearch(final int start, final int end, final AutoResizeTextRadioButton.SizeTester sizeTester, final RectF availableSpace) {
